...
tc_path = "/Users/guillermocomesanacimadevila/Desktop/mendelian randomisation/Data/Kunkle2019load_stage123.chrall.CPRA_b37.tsv"
...
ad_data <- read_tsv(tc_path, comment = "##", col_types = coltypes, 
                    col_select = c(DBSNP_ID, CHROM, POS, REF, ALT, AF, BETA, SE, Z, P, N, TRAIT))

# filter for p < 0.05
filtered_data <- filter(ad_data, P < 0.05 & P > 1e-100)
...
custom_colors <- c("skyblue", "aquamarine")
